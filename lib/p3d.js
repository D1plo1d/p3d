...
(function() {
  var ajax, base64_encode, capitalize, data, eachLine, fileExt, hermiteSpline, isWorker, k, parseXml, parserPipeline, sign, startsWith, webWorkerAttrs, webWorkerFn, webWorkerURL, _i, _len, _ref,
    _this = this,
  ...
  self.P3D = (function() {
    ...
    function P3D(src, opts) {
      ...
      args = arguments;
      if (args.length < 3 || !(this.opts != null)) {
        this.opts = {
          background: true
        };
      }
    ...
    P3D.prototype._parse = function(data) {
      ...
      parserOpts = {
        pipeline: ["_parse" + this.dataType + this.fileType],
        data: data
      };
